...
URL="https://ftp.ncbi.nlm.nih.gov/pub/datasets/command-line/v2/${ARCHITECTURE}/dataformat"
echo "Downloading NCBI dataformat CLI for ${ARCHITECTURE}..."
curl -sSLf -O "${URL}"
...
echo "NCBI dataformat CLI installation completed successfully!"
